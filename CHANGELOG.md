...
<!-- ================================================================== -->
<!--  Auto-restored entries — PR #144 … #238 (Phase audit-28 sync, 27.05.2026) -->
<!--  Format: one table row per PR. For deep-dives use `git show <sha>`.       -->
<!-- ================================================================== -->

## Index by PR — restored (#144 → #238)

| PR | Дата | Phase | Title | Ключевые файлы |
|---|---|---|---|---|
| [#238](https://github.com/AlexGolodkrd/plan-kapkan/pull/238) | 2026-05-15 | fix | fix/poly-negrisk-conditional-binary-scope\|fix(scope): block Polymarket NegRisk conditi… | `Scripts/event_matching.py` / `tests/test_phase_audit3_negrisk_conditional_binary.py` |
| [#237](https://github.com/AlexGolodkrd/plan-kapkan/pull/237) | 2026-05-15 | fix | fix/dashboard-analytics-async-await\|fix(ui): make renderAnalytics async — restores das… | `Scripts/dashboard.html` |
| [#236](https://github.com/AlexGolodkrd/plan-kapkan/pull/236) | 2026-05-15 | docs | docs/fees-verified-2026-05-15\|docs(fees): mark Limitless effectiveFeeBps=0 verified li… | `Scripts/arb_server.py` / `Scripts/dashboard.html` |
| [#235](https://github.com/AlexGolodkrd/plan-kapkan/pull/235) | 2026-05-15 | feat | feat/analytics-current-positions-panel\|feat(analytics): add current-positions panel to… | `Scripts/arb_server.py` / `Scripts/dashboard.html` |
| [#234](https://github.com/AlexGolodkrd/plan-kapkan/pull/234) | 2026-05-15 | feat | feat/partial-fill-retry-once\|feat(atomic): retry failed leg ONCE before reverting on p… | `executor-ts/src/executor/atomic.ts` |
| [#233](https://github.com/AlexGolodkrd/plan-kapkan/pull/233) | 2026-05-15 | fix | fix/sx-binary-types-swap-type1-in-type52-out\|fix(cp-arb): swap SX type=1 IN / type=52 … | `Scripts/arb_server.py` |
| [#232](https://github.com/AlexGolodkrd/plan-kapkan/pull/232) | 2026-05-15 | feat | feat/analytics-real-fills-counter\|feat(analytics): count REAL filled trades + dashboar… | `Scripts/analytics.py` / `Scripts/arb_server.py` / `Scripts/dashboard.html` |
| [#231](https://github.com/AlexGolodkrd/plan-kapkan/pull/231) | 2026-05-15 | v2 | docs/skills-update-v2-protocols\|docs(skills): update SX/Limitless to v2 protocols + dr… | `.claude/skills/cross-exchange-execution/SKILL.md` / `.claude/skills/kalshi-markets/SKILL.md` / `.claude/skills/limitless-trading/SKILL.md` / `.claude/skills/sx-bet-trading/SKILL.md` |
| [#230](https://github.com/AlexGolodkrd/plan-kapkan/pull/230) | 2026-05-15 | V2 | fix/limitless-order-id-parse-plus-allowance-alerts\|fix: Limitless V2 nested order.id +… | `Scripts/arb_server.py` / `executor-ts/src/executor/atomic.ts` / `executor-ts/src/executor/paper.ts` / `executor-ts/src/fire/lim_post.ts` |
| [#229](https://github.com/AlexGolodkrd/plan-kapkan/pull/229) | 2026-05-15 | feat | feat/dashboard-cleanup-no-dryfire-no-kalshi\|feat(dashboard): drop Dry-fire button + РИ… | `Scripts/arb_server.py` / `Scripts/dashboard.html` |
| [#228](https://github.com/AlexGolodkrd/plan-kapkan/pull/228) | 2026-05-15 | fix | fix/limitless-fee-tick-salt-venue-resolver\|fix(limitless): end-to-end working (fee 300… | `executor-ts/src/builders/limitless.ts` / `executor-ts/src/executor/atomic.ts` / `executor-ts/src/lib/limitless_profile.ts` / `executor-ts/tests/builders/limitless.test.ts` |
| [#227](https://github.com/AlexGolodkrd/plan-kapkan/pull/227) | 2026-05-15 | fix | fix/limitless-zero-expiration-sx-rawlog\|fix: Limitless sign with expiration=0 + log ra… | `executor-ts/src/builders/limitless.ts` / `executor-ts/src/executor/atomic.ts` |
| [#226](https://github.com/AlexGolodkrd/plan-kapkan/pull/226) | 2026-05-15 | fix | fix/sx-desired-odds-and-limitless-price-in-order\|fix: SX desiredOdds direction + Limit… | `executor-ts/src/builders/limitless.ts` / `executor-ts/src/builders/sx.ts` / `executor-ts/tests/builders/sx.test.ts` |
| [#225](https://github.com/AlexGolodkrd/plan-kapkan/pull/225) | 2026-05-15 | fix | fix/limitless-add-price-field\|fix(limitless): add `price` field to body — required for… | `executor-ts/src/builders/limitless.ts` |
| [#224](https://github.com/AlexGolodkrd/plan-kapkan/pull/224) | 2026-05-15 | fix | fix/sx-body-market-real-hash\|fix(sx): body.market must be real marketHash, not 'N/A' (… | `executor-ts/src/builders/sx.ts` / `executor-ts/tests/builders/sx.test.ts` |
| [#223](https://github.com/AlexGolodkrd/plan-kapkan/pull/223) | 2026-05-15 | fix | fix/limitless-expiration-string-and-parser\|fix(limitless): expiration as string + body… | `executor-ts/src/fire/lim_post.ts` / `executor-ts/src/lib/http_client.ts` |
| [#222](https://github.com/AlexGolodkrd/plan-kapkan/pull/222) | 2026-05-15 | fix | fix/limitless-numeric-amount-fields\|fix(limitless): send order numeric fields as JS Nu… | `executor-ts/src/fire/lim_post.ts` |
| [#221](https://github.com/AlexGolodkrd/plan-kapkan/pull/221) | 2026-05-15 | fix | fix/sx-body-na-and-limitless-env-override\|fix(exec): SX body.market='N/A' + Limitless … | `executor-ts/src/builders/sx.ts` / `executor-ts/src/lib/limitless_profile.ts` / `executor-ts/tests/builders/sx.test.ts` |
| [#220](https://github.com/AlexGolodkrd/plan-kapkan/pull/220) | 2026-05-15 | v2 | fix/sx-v2-and-limitless-ownerid\|fix(exec): SX OrderFill v2 + Limitless ownerId + proxy… | `executor-ts/src/builders/sx.ts` / `executor-ts/src/executor/atomic.ts` / `executor-ts/src/fire/sx_post.ts` / `executor-ts/src/lib/limitless_profile.ts` |
| [#219](https://github.com/AlexGolodkrd/plan-kapkan/pull/219) | 2026-05-15 | v28 | fix/sx-url-race-retry-docker-limits\|fix: SX URL v28 update + SX maker-race retry + doc… | `docker-compose.yml` / `executor-ts/src/executor/atomic.ts` / `executor-ts/src/types/eip712.ts` / `executor-ts/tests/builders/sx.test.ts` |
| [#218](https://github.com/AlexGolodkrd/plan-kapkan/pull/218) | 2026-05-15 | fix | fix/delete-lim-hmac-and-body-parser\|fix: deleteLimOrder HMAC parity + structured serve… | `executor-ts/src/executor/atomic.ts` / `executor-ts/src/lib/http_client.ts` |
| [#217](https://github.com/AlexGolodkrd/plan-kapkan/pull/217) | 2026-05-15 | fix | fix/proactive-protocol-defenses\|fix: pre-empt 6 protocol failure modes for when proxy … | `executor-ts/src/builders/limitless.ts` / `executor-ts/src/builders/poly.ts` / `executor-ts/src/executor/atomic.ts` / `executor-ts/src/lib/http_client.ts` |
| [#216](https://github.com/AlexGolodkrd/plan-kapkan/pull/216) | 2026-05-15 | fix | fix/proxy-only-on-post-not-fetch\|fix(proxy): residential only on physical order POSTs,… | `Scripts/arb_server.py` / `executor-ts/src/executor/atomic.ts` / `executor-ts/src/fire/sx_fetch.ts` |
| [#215](https://github.com/AlexGolodkrd/plan-kapkan/pull/215) | 2026-05-15 | fix | fix/surface-http-response-body\|chore(http): include response body snippet in HttpError… | `executor-ts/src/lib/http_client.ts` |
| [#214](https://github.com/AlexGolodkrd/plan-kapkan/pull/214) | 2026-05-15 | fix | fix/timeout-bump-and-lim-hmac-secret\|fix: bump per-leg timeout to 8s + pass Limitless … | `executor-ts/src/executor/atomic.ts` / `executor-ts/src/fire/lim_post.ts` / `executor-ts/src/fire/poly_post.ts` / `executor-ts/src/fire/sx_post.ts` |
| [#213](https://github.com/AlexGolodkrd/plan-kapkan/pull/213) | 2026-05-15 | fix | fix/sticky-opt-in-and-bigint-leg-rows\|fix: SOCKS5 sticky opt-in + BigInt-safe logOrder… | `executor-ts/src/executor/paper.ts` / `executor-ts/src/lib/proxy_pool.ts` |
| [#212](https://github.com/AlexGolodkrd/plan-kapkan/pull/212) | 2026-05-15 | fix | fix/socks5-api-and-bigint-json\|fix: SOCKS5 via socks package + BigInt-safe JSON | `executor-ts/package-lock.json` / `executor-ts/package.json` / `executor-ts/src/fire/lim_post.ts` / `executor-ts/src/fire/poly_post.ts` |
| [#211](https://github.com/AlexGolodkrd/plan-kapkan/pull/211) | 2026-05-15 | fix | fix/residential-proxy-and-side-translation\|fix: residential proxy on sx_fetch + side Y… | `Scripts/arb_server.py` / `executor-ts/src/executor/atomic.ts` / `executor-ts/src/fire/sx_fetch.ts` / `executor-ts/src/lib/proxy_pool.ts` |
| [#210](https://github.com/AlexGolodkrd/plan-kapkan/pull/210) | 2026-05-15 | fix | fix/signing-audit-and-sx-fetch\|fix: signing-pipeline audit — SX live orderbook + Limit… | `Scripts/arb_server.py` / `executor-ts/src/executor/atomic.ts` / `executor-ts/src/executor/paper.ts` / `executor-ts/src/fire/sx_fetch.ts` |
| [#209](https://github.com/AlexGolodkrd/plan-kapkan/pull/209) | 2026-05-15 | fix | fix/live-fire-and-cap-recompute\|fix: env-driven live-fire + CP face cap honors MAX_PER… | `Scripts/arb_server.py` / `Scripts/cross_platform.py` |
| [#208](https://github.com/AlexGolodkrd/plan-kapkan/pull/208) | 2026-05-15 | fix | fix/per-trade-cap-clip-not-abort\|fix(risk): per-trade cap clips the stake instead of a… | `Scripts/cross_platform.py` / `executor-ts/src/executor/atomic.ts` / `executor-ts/src/executor/paper.ts` / `executor-ts/src/risk/limits.ts` |
| [#207](https://github.com/AlexGolodkrd/plan-kapkan/pull/207) | 2026-05-15 | feat | feat/wallet-reuse-flag\|feat(wallets): ALLOW_WALLET_REUSE env — 1 bot can fire 2+ leg arbs | `executor-ts/src/wallets/pool.ts` / `executor-ts/tests/wallets/pool.test.ts` |
| [#206](https://github.com/AlexGolodkrd/plan-kapkan/pull/206) | 2026-05-14 | fix | fix/telegram-startup-notify-order\|fix(startup): telegram banner NameError swallowed af… | `Scripts/arb_server.py` |
| [#205](https://github.com/AlexGolodkrd/plan-kapkan/pull/205) | 2026-05-14 | fix | fix/dry-run-env-file-truth\|fix(compose): DRY_RUN sourced from env_file, not environmen… | `docker-compose.yml` |
| [#204](https://github.com/AlexGolodkrd/plan-kapkan/pull/204) | 2026-05-14 | fix | fix/compose-healthcheck-ipv4\|fix(compose): executor-ts healthcheck explicit 127.0.0.1 | `docker-compose.yml` |
| [#203](https://github.com/AlexGolodkrd/plan-kapkan/pull/203) | 2026-05-14 | fix | fix/live-readiness-hardening\|fix: live-readiness hardening (risk env, healthcheck IPv6… | `Scripts/risk/state.py` / `executor-ts/Dockerfile` / `executor-ts/src/risk/state.ts` / `executor-ts/src/ws/limitless_user_ws.ts` |
| [#202](https://github.com/AlexGolodkrd/plan-kapkan/pull/202) | 2026-05-14 | fix | fix/dashboard-proxy-label-states\|fix(ui): proxy panel label reflects lazy keepalive state | `Scripts/dashboard.html` |
| [#201](https://github.com/AlexGolodkrd/plan-kapkan/pull/201) | 2026-05-14 | fix | fix/ts-5h2-limitless-ctf-default\|fix(approve): default Limitless CTF address for setAp… | `Scripts/limitless_approve.py` |
| [#200](https://github.com/AlexGolodkrd/plan-kapkan/pull/200) | 2026-05-14 | fix | fix/ts-5h-poly-onramp-wrap-abi\|fix(approve): residential proxy + polymarket wrap ABI | `Scripts/limitless_approve.py` / `Scripts/polymarket_approve.py` |
| [#199](https://github.com/AlexGolodkrd/plan-kapkan/pull/199) | 2026-05-14 | feat | feat/ts-5g-socks5-proxy\|feat(ts-5g): SOCKS5 proxy support (pool.proxy.market) | `executor-ts/package-lock.json` / `executor-ts/package.json` / `executor-ts/src/lib/proxy_pool.ts` / `executor-ts/tests/lib/proxy_pool.test.ts` |
| [#198](https://github.com/AlexGolodkrd/plan-kapkan/pull/198) | 2026-05-14 | ts-5f.5 | feat/ts-5f5-user-ws-hmac-and-env-example\|feat(ts-5f.5): user-WS HMAC + Credentials.env… | `Credentials.env.example` / `executor-ts/src/types/wallet.ts` / `executor-ts/src/wallets/pool.ts` / `executor-ts/src/ws/limitless_user_ws.ts` |
| [#197](https://github.com/AlexGolodkrd/plan-kapkan/pull/197) | 2026-05-14 | ts-5f.4 | fix/ts-5f4-audit-watchdog-and-delete-lim\|fix(ts-5f.4): final audit - watchdog + delete… | `Scripts/watchdog.py` / `executor-ts/src/fire/lim_post.ts` |
| [#196](https://github.com/AlexGolodkrd/plan-kapkan/pull/196) | 2026-05-14 | ts-5f.3 | feat/ts-5f3-limitless-ws-hmac-and-audit\|feat(ts-5f.3): Limitless WS HMAC + reconcile +… | `Scripts/arb_server.py` / `Scripts/limitless_ws.py` / `Scripts/risk/reconcile.py` / `Scripts/wallets/config.py` |
| [#195](https://github.com/AlexGolodkrd/plan-kapkan/pull/195) | 2026-05-14 | ts-5f.2 | feat/ts-5f2-python-limitless-hmac\|feat(ts-5f.2): Python Limitless HMAC signer + 3 REST… | `Scripts/arb_server.py` / `Scripts/executor/atomic.py` / `Scripts/executor/builders.py` / `Scripts/limitless_hmac.py` |
| [#194](https://github.com/AlexGolodkrd/plan-kapkan/pull/194) | 2026-05-14 | feat | feat/ts-5f-limitless-hmac-signer\|feat(ts-5f): Limitless HMAC-SHA256 request signer | `.claude/skills/limitless-hmac-auth/SKILL.md` / `executor-ts/src/fire/lim_post.ts` / `executor-ts/src/lib/limitless_hmac.ts` / `executor-ts/tests/lib/limitless_hmac.test.ts` |
| [#193](https://github.com/AlexGolodkrd/plan-kapkan/pull/193) | 2026-05-14 | feat | feat/ts-5e-bot-count-env\|feat(ts-5e): BOT_COUNT + MIN_USDC_PER_BOT env-overridable | `Scripts/wallets/config.py` / `executor-ts/src/wallets/pool.ts` / `tests/test_phase_ts5e_bot_count_env.py` |
| [#192](https://github.com/AlexGolodkrd/plan-kapkan/pull/192) | 2026-05-14 | fix | fix/poly-derive-400-fallback-and-ascii\|fix(poly): derive_api_creds handle 400 + ASCII-… | `Scripts/poly_derive_api_creds.py` |
| [#191](https://github.com/AlexGolodkrd/plan-kapkan/pull/191) | 2026-05-14 | ts-5d.2 | feat/ts-5d.2-proxy-ui-panel\|feat(ts-5d.2): proxy keepalive state panel in dashboard | `Scripts/dashboard.html` / `executor-ts/src/server.ts` |
| [#190](https://github.com/AlexGolodkrd/plan-kapkan/pull/190) | 2026-05-14 | ts-5d.1 | feat/ts-5d.1-proxy-keepalive\|feat(ts-5d.1): keepalive ticker for residential proxy sti… | `executor-ts/src/lib/proxy_pool.ts` / `executor-ts/tests/lib/proxy_pool.test.ts` |
| [#189](https://github.com/AlexGolodkrd/plan-kapkan/pull/189) | 2026-05-14 | feat | feat/ts-5d-residential-proxy\|feat(ts-5d): residential proxy routing for order placement | `.claude/skills/residential-proxy-routing/SKILL.md` / `executor-ts/package-lock.json` / `executor-ts/package.json` / `executor-ts/src/fire/lim_post.ts` |
| [#188](https://github.com/AlexGolodkrd/plan-kapkan/pull/188) | 2026-05-14 | feat | feat/ts-5c-polymarket-ws-required\|feat(ts-5c): Polymarket WS-required mode (symmetric … | `Scripts/arb_server.py` / `tests/test_phase_audit3_polymarket_ws_required.py` |
| [#187](https://github.com/AlexGolodkrd/plan-kapkan/pull/187) | 2026-05-14 | fix | fix/polymarket-fee-schedule-source\|fix(poly): read feeSchedule as primary, fall back t… | `.claude/skills/polymarket-fee-schedule/SKILL.md` / `.claude/skills/polymarket-heartbeats-cancel/SKILL.md` / `.claude/skills/polymarket-keyset-pagination/SKILL.md` / `.claude/skills/polymarket-post-v2-status/SKILL.md` |
| [#186](https://github.com/AlexGolodkrd/plan-kapkan/pull/186) | 2026-05-14 | v2 | docs/polymarket-post-v2-skills\|docs(skills): Polymarket post-V2 changes affecting rada… | `.claude/skills/polymarket-fee-schedule/SKILL.md` / `.claude/skills/polymarket-heartbeats-cancel/SKILL.md` / `.claude/skills/polymarket-keyset-pagination/SKILL.md` / `.claude/skills/polymarket-post-v2-status/SKILL.md` |
| [#185](https://github.com/AlexGolodkrd/plan-kapkan/pull/185) | 2026-05-14 | feat | feat/sparkline-data-exposure\|feat(api): opt-in ?series=1 for /api/scan_health raw valu… | `.claude/skills/polymarket-fee-schedule/SKILL.md` / `.claude/skills/polymarket-heartbeats-cancel/SKILL.md` / `.claude/skills/polymarket-keyset-pagination/SKILL.md` / `.claude/skills/polymarket-post-v2-status/SKILL.md` |
| [#184](https://github.com/AlexGolodkrd/plan-kapkan/pull/184) | 2026-05-14 | feat | feat/ts-5a-limitless-ws-stability\|feat(ts-5a): LimitlessWS stability hardening + WS-re… | `.claude/skills/polymarket-fee-schedule/SKILL.md` / `.claude/skills/polymarket-heartbeats-cancel/SKILL.md` / `.claude/skills/polymarket-keyset-pagination/SKILL.md` / `.claude/skills/polymarket-post-v2-status/SKILL.md` |
| [#183](https://github.com/AlexGolodkrd/plan-kapkan/pull/183) | 2026-05-14 | fix | fix/scan-breakdown-async-zero\|fix(scan): t_sx/t_lim wall-clock when BG prefetch finish… | `.claude/skills/polymarket-fee-schedule/SKILL.md` / `.claude/skills/polymarket-heartbeats-cancel/SKILL.md` / `.claude/skills/polymarket-keyset-pagination/SKILL.md` / `.claude/skills/polymarket-post-v2-status/SKILL.md` |
| [#182](https://github.com/AlexGolodkrd/plan-kapkan/pull/182) | 2026-05-12 | hotfix | hotfix/disable-async-permanently\|hotfix(scan): disable async default permanently (Limi… | `Scripts/arb_server.py` |
| [#181](https://github.com/AlexGolodkrd/plan-kapkan/pull/181) | 2026-05-12 | feat | feat/async-rate-safe-concurrency\|perf(scan): re-enable async fetch with rate-safe conc… | `Scripts/arb_server.py` |
| [#180](https://github.com/AlexGolodkrd/plan-kapkan/pull/180) | 2026-05-12 | hotfix | hotfix/revert-async-default-rate-limited\|hotfix(scan): revert ASYNC_FETCH default — Li… | `Scripts/arb_server.py` |
| [#179](https://github.com/AlexGolodkrd/plan-kapkan/pull/179) | 2026-05-12 | phase via | feat/limitless-scan-speedup\|perf(scan): cut Limitless phase via async default + page/c… | `Scripts/arb_server.py` |
| [#178](https://github.com/AlexGolodkrd/plan-kapkan/pull/178) | 2026-05-12 | feat | feat/scan-breakdown-per-platform\|feat(observability): per-platform scan breakdown in /… | `Scripts/arb_server.py` / `tests/test_phase_audit2_scan_breakdown.py` |
| [#177](https://github.com/AlexGolodkrd/plan-kapkan/pull/177) | 2026-05-12 | chore | chore/cut-kalshi-scan-path\|chore(scan): default ENABLE_KALSHI=0 to cut dead-air from s… | `Scripts/arb_server.py` |
| [#176](https://github.com/AlexGolodkrd/plan-kapkan/pull/176) | 2026-05-12 | feat | feat/analytics-unique-event-count\|feat(analytics): unique-event count + ratio in /api/… | `Scripts/analytics.py` / `Scripts/dashboard.html` / `tests/test_phase_audit2_analytics_unique_count.py` |
| [#175](https://github.com/AlexGolodkrd/plan-kapkan/pull/175) | 2026-05-11 | chore | chore/reset-workflow-add-pipeline-and-ts\|chore(reset): wipe pipeline_timings + analyti… | `.github/workflows/reset.yml` |
| [#174](https://github.com/AlexGolodkrd/plan-kapkan/pull/174) | 2026-05-11 | chore | chore/nginx-exception-exchange-rtt\|chore(nginx): expose /api/exchange_rtt publicly (no… | `.github/workflows/apply-nginx-exchange-rtt.yml` |
| [#173](https://github.com/AlexGolodkrd/plan-kapkan/pull/173) | 2026-05-11 | feat | feat/exchange-latency-shadow-probe\|feat(observability): shadow probe for real-mode exc… | `Scripts/arb_server.py` / `Scripts/exchange_latency_probe.py` / `tests/test_phase_audit2_exchange_rtt_probe.py` |
| [#172](https://github.com/AlexGolodkrd/plan-kapkan/pull/172) | 2026-05-11 | chore | chore/remove-pipeline-panel-from-ui\|chore(ui): remove pipelinePanel from header | `Scripts/dashboard.html` |
| [#171](https://github.com/AlexGolodkrd/plan-kapkan/pull/171) | 2026-05-11 | feat | feat/scan-tick-timing-and-1s-dashboard\|feat(observability): scan-tick timing + 1s dash… | `Scripts/arb_server.py` / `Scripts/dashboard.html` / `tests/test_phase_audit2_scan_tick_timing.py` |
| [#170](https://github.com/AlexGolodkrd/plan-kapkan/pull/170) | 2026-05-11 | fix | fix/dashboard-pipeline-panel-and-limitless-deadline\|fix(ux): Limitless deadline ISO + … | `Scripts/arb_server.py` / `Scripts/dashboard.html` / `tests/test_phase_audit2_limitless_deadline_iso.py` |
| [#169](https://github.com/AlexGolodkrd/plan-kapkan/pull/169) | 2026-05-11 | fix | fix/ts-dryrun-optimistic-simpnl\|fix(simPnl): dry-run uses optimistic formula regardles… | `executor-ts/src/executor/atomic.ts` / `executor-ts/tests/dryrun_simpnl.test.ts` |
| [#168](https://github.com/AlexGolodkrd/plan-kapkan/pull/168) | 2026-05-11 | fix | fix/ts-expected-payout-from-radar\|fix(simPnl): radar passes expectedPayout to TS execu… | `Scripts/arb_server.py` / `executor-ts/src/executor/atomic.ts` / `executor-ts/src/types/deal.ts` / `executor-ts/tests/fire_payout.test.ts` |
| [#167](https://github.com/AlexGolodkrd/plan-kapkan/pull/167) | 2026-05-11 | hotfix | hotfix/executor-ts-use-builtin-node-user\|hotfix(executor-ts): use built-in node user (… | `executor-ts/Dockerfile` |
| [#166](https://github.com/AlexGolodkrd/plan-kapkan/pull/166) | 2026-05-11 | fix | fix/executor-ts-uid-match-radar\|fix(executor-ts): align UID 1000 with radar to fix EAC… | `.github/workflows/apply-nginx-pipeline-timings-and-active-deals.yml` / `Scripts/analytics.py` / `Scripts/arb_server.py` / `Scripts/cross_platform.py` |
| [#165](https://github.com/AlexGolodkrd/plan-kapkan/pull/165) | 2026-05-11 | fix | fix/cp-leg-identifiers-for-ts-executor\|fix(cross-platform): thread platform IDs onto C… | `Scripts/arb_server.py` / `Scripts/cross_platform.py` / `tests/test_phase_audit2_cp_leg_identifiers.py` |
| [#164](https://github.com/AlexGolodkrd/plan-kapkan/pull/164) | 2026-05-11 | feat | feat/ts-metrics-error-reason-breakdown\|feat(ts-metrics): per-reason error + aborted br… | `Scripts/arb_server.py` / `Scripts/cross_platform.py` / `executor-ts/src/server.ts` / `executor-ts/tests/server_metrics.test.ts` |
| [#163](https://github.com/AlexGolodkrd/plan-kapkan/pull/163) | 2026-05-11 | feat | feat/cp-pipeline-timing-instrumentation\|feat(pipeline-timing): per-stage latency logs … | `.github/workflows/apply-nginx-pipeline-timings-and-active-deals.yml` / `Scripts/analytics.py` / `Scripts/arb_server.py` / `Scripts/cross_platform.py` |
| [#162](https://github.com/AlexGolodkrd/plan-kapkan/pull/162) | 2026-05-11 | fix | fix/executor-url-default-+-realtime-lifespan\|fix(BUG-F1): EXECUTOR_URL default + real-… | `Scripts/analytics.py` / `Scripts/arb_server.py` |
| [#161](https://github.com/AlexGolodkrd/plan-kapkan/pull/161) | 2026-05-11 | chore | chore/nginx-paper-endpoints\|chore(nginx): expose paper-trading endpoints publicly (no … | `.github/workflows/apply-nginx-paper-endpoints.yml` |
| [#160](https://github.com/AlexGolodkrd/plan-kapkan/pull/160) | 2026-05-11 | feat | feat/smart-matcher-fuzzy-alias-fallback\|feat(smart-matcher): league-derived sport fall… | `Scripts/event_matching.py` / `tests/test_phase_audit2_leagues.py` |
| [#159](https://github.com/AlexGolodkrd/plan-kapkan/pull/159) | 2026-05-11 | feat | feat/smart-matcher-leagues\|feat(smart-matcher): league/competition guard (Strategy #2) | `Scripts/cross_platform.py` / `Scripts/event_matching.py` / `tests/test_phase_audit2_leagues.py` |
| [#158](https://github.com/AlexGolodkrd/plan-kapkan/pull/158) | 2026-05-11 | chore | chore/remove-maker-orders-strategy\|chore: remove maker-order strategy (operator decision) | `.claude/skills/maker-taker-orders/SKILL.md` / `.claude/skills/maker-testing/SKILL.md` / `Scripts/executor/atomic.py` / `Scripts/executor/builders.py` |
| [#157](https://github.com/AlexGolodkrd/plan-kapkan/pull/157) | 2026-05-11 | audit-2 | fix/draw-vs-team-phantom-1x2\|fix(audit-2): reject Draw × team-NO 1X2 phantoms (BUG-E7) | `Scripts/event_matching.py` / `tests/test_phase_audit2_phantom_cp_matches.py` |
| [#156](https://github.com/AlexGolodkrd/plan-kapkan/pull/156) | 2026-05-11 | feat | feat/cp-diag-reason-counters\|feat(cp-diag): rejection-reason counters in /api/cp_pairi… | `Scripts/cross_platform.py` |
| [#155](https://github.com/AlexGolodkrd/plan-kapkan/pull/155) | 2026-05-11 | audit-2 | fix/equal-payout-sizing-and-safety-factor\|fix(audit-2): equal-payout arb sizing + 20% … | `Scripts/cross_platform.py` / `tests/test_phase19v34_cp_fee_roi.py` |
| [#154](https://github.com/AlexGolodkrd/plan-kapkan/pull/154) | 2026-05-11 | audit-2 | fix/phantom-cross-platform-matches\|fix(audit-2): phantom CP matches + per-leg UI bugs … | `Scripts/cross_platform.py` / `Scripts/dashboard.html` / `Scripts/event_matching.py` / `tests/test_phase_audit2_phantom_cp_matches.py` |
| [#153](https://github.com/AlexGolodkrd/plan-kapkan/pull/153) | 2026-05-11 | chore | chore/nginx-cp-pairing-diag-paper-skip-reasons\|chore(nginx): apply workflow for /api/c… | `.github/workflows/apply-nginx-cp-pairing-diag.yml` |
| [#152](https://github.com/AlexGolodkrd/plan-kapkan/pull/152) | 2026-05-11 | chore | chore/audit-residuals-c1-c3-q4\|chore(audit-tail): C2/C3 + BUG-D1 (phantom poly_l2_http… | `BUG_CATALOG.md` / `Scripts/arb_server.py` / `docs/AUTO_DEPLOY_GOTCHAS.md` / `docs/PROJECT_AUDIT_2026-05-11.md` |
| [#151](https://github.com/AlexGolodkrd/plan-kapkan/pull/151) | 2026-05-11 | chore | chore/cleanup-bug-fixes-batch1\|chore(audit): BUG-A2/A3 + B2 + SZ-1/3/4 + 4 TS skills +… | `.claude/skills/eip712-typescript-parity/SKILL.md` / `.claude/skills/fillregistry-pattern/SKILL.md` / `.claude/skills/vitest-mocks/SKILL.md` / `.claude/skills/ws-listener-lifecycle/SKILL.md` |
| [#150](https://github.com/AlexGolodkrd/plan-kapkan/pull/150) | 2026-05-11 | docs | docs/idea-md-current-state-banner\|docs(idea.md): add current-state banner with TS migr… | `idea.md` |
| [#149](https://github.com/AlexGolodkrd/plan-kapkan/pull/149) | 2026-05-11 | chore | chore/code-cleanup-audit-items\|chore: cleanup (bare except, unused imports, stale TODO… | `.github/workflows/apply-nginx-scan-health.yml` / `Scripts/arb_server.py` |
| [#148](https://github.com/AlexGolodkrd/plan-kapkan/pull/148) | 2026-05-11 | ts-5c.3 | feat/ts-5c.3-atomic-fillregistry-wiring\|feat(ts-5c.3): atomic.ts - WS pre-subscribe wi… | `executor-ts/src/executor/atomic.ts` / `executor-ts/src/server.ts` / `executor-ts/src/ws/poly_user_ws.ts` / `executor-ts/src/ws/ws_manager.ts` |
| [#147](https://github.com/AlexGolodkrd/plan-kapkan/pull/147) | 2026-05-11 | docs | docs/credentials-guide-and-audit\|docs: CREDENTIALS_GUIDE + PROJECT_AUDIT 2026-05-11 | `docs/CREDENTIALS_GUIDE.md` / `docs/PROJECT_AUDIT_2026-05-11.md` |
| [#146](https://github.com/AlexGolodkrd/plan-kapkan/pull/146) | 2026-05-11 | feat | feat/audit-extras-snapshot-near-cleanup\|feat(audit-extras): _snapshot + /api/recent_ne… | `.github/workflows/apply-nginx-recent-near.yml` / `Scripts/analytics.py` / `Scripts/arb_server.py` |
| [#145](https://github.com/AlexGolodkrd/plan-kapkan/pull/145) | 2026-05-11 | chore | chore/commit-skills\|chore: commit .claude/skills/ to repo (37 skills) | `.claude/skills/async-python-patterns/SKILL.md` / `.claude/skills/auto-deploy-gotchas/SKILL.md` / `.claude/skills/browser-cache-busting/SKILL.md` / `.claude/skills/circuit-breaker-patterns/SKILL.md` |
| [#144](https://github.com/AlexGolodkrd/plan-kapkan/pull/144) | 2026-05-11 | docs | docs/audit-ts5-ts6-and-deploy-lessons\|docs: CHANGELOG + BUG_CATALOG + AUTO_DEPLOY_GOTCHAS | `BUG_CATALOG.md` / `CHANGELOG.md` / `docs/AUTO_DEPLOY_GOTCHAS.md` |
